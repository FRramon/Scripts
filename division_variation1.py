...
def _main_(pinfo, case, step):
    ...
    # if get_method_div_A(pinfo, case,step) == "auto":
    #     dpoints = add_divided_arteries(dpoints, dpoints_divACA)
    # else:
    #     dpoints = add_divided_arteries(dpoints, dpoints_divLACA)
    #     dpoints = add_divided_arteries(dpoints, dpoints_divRACA)
